...
from Config import START_MSG, CHANNELS, ADMINS, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, JOIN OUR GROUP, BROADCAST_CHANNEL, DB_URL, SESSION, ADMIN_ID    
    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🎖 join our group 🎖', url=f'{JOIN OUR GROUP}')
                    ]
                    ]
